...
namespace SB.Migrator.Postgres
{
    ...
    /// 
    /// </summary>
    public class PostgresPrimaryKeyManager : PostgresBaseMappingManager
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public PostgresPrimaryKeyManager(PostgresDatabaseTablesManager databaseTablesManager) : base(databaseTablesManager)
        {
